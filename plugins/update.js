...
cmd({
    ...
    try {
        await reply("*🔍 Checking for 𝐋𝐈𝐎𝐍-𝐕2 updates...*");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/macoder67/LION-V2/commits/main");
        ...
        await reply("LIOON-V2 UPDATING WAIT PLS 👨‍💻...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/macoder67/LION-V2/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "LION-V2-main");
